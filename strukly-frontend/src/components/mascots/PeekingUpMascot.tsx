...
interface PeekingUpMascotProps extends SVGProps<SVGSVGElement> {}

export default function PeekingUpMascot(props: PeekingUpMascotProps) {
  return (
    <svg
      width="64"
      height="69"
    ...
    >
      ...
      <circle
        ...
        cy="6.28571"
        r="6.28571"
        transform="matrix(-1 0 0 1 51.5714 24)"
        fill="#2E2E2E"
      />
      <circle
        cx="11.7857"
      ...
      <circle
        ...
        cy="6.28571"
        r="6.28571"
        transform="matrix(-1 0 0 1 30.5714 24)"
        fill="#2E2E2E"
      />
    </svg>
  );
